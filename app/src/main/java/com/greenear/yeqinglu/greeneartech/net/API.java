...
public class API {
    ...
    public static final String BMS_INFO ="http://bms.greeneartech.com/bms/index";
    public static final String BAT_INFO = "http://bms.greeneartech.com/bat/index?bms_id=10";
